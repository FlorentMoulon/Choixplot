    ...
    if (score[0]>=score[1] && score[0]>=score[2] && score[0]>=score[3]){
        ...
        return(
            <div className="cpBoxEnd">
                ...
                <p>Tu es loyal(e) et n&apos;hésites pas à soutenir les gens vers le haut. Tu es toujours présent(e) pour les aider à traverser des périodes difficiles. Sans toi, tes compagnons de route tomberaient au fond du gouffre.</p> 
            </div>
        )
        ...
        return(
            <div className="cpBoxEnd">
                ...
                <p>Tu le sais, tu es très rusé. Telle le rat que tu es, tu ramasses l&apos;argent de tes compagnons de routes en leur promettant loyauté et de meilleures autoroutes. Pourtant, tu ne peux t&apos;empêcher de garder cette moula dans ta poche. Tu n&apos;acceptes pas de rendre un service si tu n&apos;obtiens rien en retour.</p> 
            </div>
        )
        ...
        return(
            <div className="cpBoxEnd">
                ...
                <p>Tu connais ton code sur le bout des doigts. L&apos;intelligence et toi, ça ne fait qu&apos;un. D&apos;aucuns disent que ton QI est plus élevé que celui d&apos;Einstein. D&apos;autres estiment que tu es un superhéros de la conduite. Tu ne t&apos;es jamais fait flashé et tu sais que ça n&apos;arrivera jamais. Avec toi, pas besoin de GPS ni de passager, tu connais tes cartes mieux que Michelin !</p> 
            </div>
        )
    }
